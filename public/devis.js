...
function resize() {
    let d_height = document.getElementById('devis_container').offsetHeight;
    let d_width = d_height / 1.41;
    $('#devis_container').css('width', d_width);
}
...
document.getElementById('devis_ref').innerHTML = "Référence du devis:" + estimate_number;
...
$("#save").click(function () {
    ...
    var w = document.getElementById("devis_container").offsetWidth;
    var h = document.getElementById("devis_container").offsetHeight;
    let node = document.getElementById('devis_container');
